...
module mk_perlin (I: integral) (E: rng_engine with t = I.t) : perlin with rng = E.rng = {
  type perlin [n] =
    { ranvec: [n]vec3
    , perm_x: [n]i32
    , perm_y: [n]i32
  ...
  type rng = E.rng
  module shuffle = mk_shuffle I E
  module dist = uniform_real_distribution f32 I E
  ...
  def turb perlin (depth: i32) p =
    f32.abs
    <| (.0)
       <| loop (accum, temp_p, weight) = (0, p, 1)
          for _i < depth do
